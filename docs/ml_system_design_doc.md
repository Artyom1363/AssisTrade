...
| ------------- | ------------- | ------------- | ------------- | ------------- | ------------- |
| Транзакции | Сообщения, в которых пользователь просит перевести своему контакту определенное кол-во валюты (возможно в определенной сети) | Данных нет, предлагается сгенерировать корзинку с помощью gpt модели | DE/DS | - | Построение транзакций |
...
| Интенты | Сообщения с размеченным интентом пользователя (например, на 3 класса: транзакция, вопрос, добавление контактов) | Данных нет, предлагается сгенерировать корзинку с помощью gpt модели | DE/DS | - | Определение интента |
