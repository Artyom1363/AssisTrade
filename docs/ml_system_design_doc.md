...
| Эндпоинт | Запросов | Успешность | Среднее (мс) | Минимум (мс) | Максимум (мс) | Медиана (мс) | RPS |
|----------|----------|------------|--------------|--------------|---------------|--------------|-----|
| **POST /query** | 16 | 100% | 5,567 | 2,769 | 9,373 | 5,500 | 0.28 |
| **GET /health** | 4 | 100% | 3,596 | 1,898 | 5,282 | 2,900 | 0.07 |
| **Общие показатели** | **20** | **100%** | **5,173** | **1,898** | **9,373** | **5,300** | **0.35** |

### Перцентили времени отклика (мс)

| Эндпоинт | 50% | 66% | 75% | 80% | 90% | 95% | 98% | 99% | 99.9% | 100% |
|----------|-----|-----|-----|-----|-----|-----|-----|-----|-------|------|
| **POST /query** | 5,700 | 7,000 | 7,400 | 7,400 | 7,500 | 9,400 | 9,400 | 9,400 | 9,400 | 9,400 |
| **GET /health** | 4,300 | 4,300 | 5,300 | 5,300 | 5,300 | 5,300 | 5,300 | 5,300 | 5,300 | 5,300 |
| **Общие показатели** | **5,400** | **6,500** | **7,100** | **7,400** | **7,500** | **9,400** | **9,400** | **9,400** | **9,400** | **9,400** |
...
| Эндпоинт | 50% | 66% | 75% | 80% | 90% | 95% | 98% | 99% | 99.9% | 100% |
|----------|-----|-----|-----|-----|-----|-----|-----|-----|-------|------|
| **POST /query** | 14 | 15 | 16 | 16 | 17 | 24 | 24 | 24 | 24 | 24 |
| **Общие показатели** | **14** | **15** | **16** | **16** | **17** | **24** | **24** | **24** | **24** | **24** |
